# coding: utf-8
try:
    from mediapipe.framework.formats import landmark_pb2  # type: ignore[reportMissingImports]
except ImportError:
    landmark_pb2 = None
...
def on_result(result: object, output_image: object, timestamp_ms: int):
    global _last_result
    _last_result = (result, timestamp_ms)

def _to_proto(hand_lms) -> "landmark_pb2.NormalizedLandmarkList":
    if landmark_pb2 is None:
        raise RuntimeError("mediapipe.framework.formats.landmark_pb2 not available in this environment.")
